...
/**
 * This is the item provider adapter for a {@link sbd.Job} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class JobItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SbdPackage.Literals.JOB__STEPS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Job.class)) {
			case SbdPackage.JOB__ID:
			case SbdPackage.JOB__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case SbdPackage.JOB__STEPS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SbdPackage.Literals.JOB__STEPS,
				 SbdFactory.eINSTANCE.createStep()));
	}
